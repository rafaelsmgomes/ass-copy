...
const bigBlurbSlice = createSlice({
  name: 'bigBlurbs',
  initialState,
  reducers: {},
})

export default bigBlurbSlice

export const selectBigBlurbs = (s: RootState) => s.bigBlurbs
